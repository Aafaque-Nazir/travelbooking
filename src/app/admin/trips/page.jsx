        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                {services.map(service => (
                    <div key={service.id} className="p-5 bg-zinc-900/40 border border-white/5 rounded-xl hover:border-indigo-500/30 transition-all flex items-center justify-between group">
                        <div className="flex items-center gap-6">
                            <div className="flex flex-col items-center bg-zinc-800 px-4 py-2.5 rounded-lg min-w-[80px]">
                                <span className="text-xs text-zinc-500 uppercase font-bold tracking-wider">DAILY</span>
                                <span className="text-xl font-bold text-white">{service.departure_time?.slice(0,5)}</span>
                            </div>
                        ...
                        <div className="flex items-center gap-6">
                             ...
                             <button onClick={() => handleDelete(service.id)} className="p-2 text-zinc-600 hover:text-red-400 transition-colors">
